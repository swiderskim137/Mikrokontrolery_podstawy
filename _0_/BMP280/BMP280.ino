...
void saveValues() {
  ...
  plik.print("t = ");
  plik.print(millis() / 1000);
  plik.print(" s   ");

  plik.print("T = ");
  plik.print(bme.readTemperature());
  plik.print(" *C   ");

  plik.print("Humidity = ");
  plik.print(bme.readHumidity());
  plik.print(" %   ");

  plik.print("P = ");
  plik.print(bme.readPressure() / 100.0F);
  plik.print(" hPa   ");

  plik.print("App.Alt = ");
  plik.print(bme.readAltitude(SEALEVELPRESSURE_HPA) - h0);
  plik.println(" m");
